...
/**
 * Java class for UnderlyingStreamCommoditySettlPeriodNotionalUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="UnderlyingStreamCommoditySettlPeriodNotionalUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "UnderlyingStreamCommoditySettlPeriodNotionalUnitOfMeasure_enum_t")
@XmlEnum
public enum UnderlyingStreamCommoditySettlPeriodNotionalUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  UnderlyingStreamCommoditySettlPeriodNotionalUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static UnderlyingStreamCommoditySettlPeriodNotionalUnitOfMeasureEnumT fromValue(String v) {
    for (UnderlyingStreamCommoditySettlPeriodNotionalUnitOfMeasureEnumT c :
        UnderlyingStreamCommoditySettlPeriodNotionalUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
