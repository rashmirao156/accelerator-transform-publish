...
/**
 * CollateralReport can be found in Volume 5 of the specification
 *
...
@XmlType(
  name = "CollateralReport_message_t",
  propOrder = {
    "pty",
    "collExc",
    "trdColl",
...
public class CollateralReportMessageT extends AbstractMessageT {
