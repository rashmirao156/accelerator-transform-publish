...
/**
 * PartyDetailsListRequest can be found in Volume 3 of the specification
 *
...
@XmlType(
  name = "PartyDetailsListRequest_message_t",
  propOrder = {"reqPty", "pty", "reqR", "rltnshp"}
)
public class PartyDetailsListRequestMessageT extends AbstractMessageT {
