...
/**
 * Java class for LegStreamTotalNotionalUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="LegStreamTotalNotionalUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "LegStreamTotalNotionalUnitOfMeasure_enum_t")
@XmlEnum
public enum LegStreamTotalNotionalUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  LegStreamTotalNotionalUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static LegStreamTotalNotionalUnitOfMeasureEnumT fromValue(String v) {
    for (LegStreamTotalNotionalUnitOfMeasureEnumT c :
        LegStreamTotalNotionalUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
