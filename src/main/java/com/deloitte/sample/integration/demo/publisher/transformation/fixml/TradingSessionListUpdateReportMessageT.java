...
/**
 * TradingSessionListUpdateReport can be found in Volume 3 of the specification
 *
...
@XmlType(
  name = "TradingSessionListUpdateReport_message_t",
  propOrder = {"applSeqCtrl", "trdSessLstGrp"}
)
public class TradingSessionListUpdateReportMessageT extends AbstractMessageT {
