...
/**
 * Java class for PaymentScheduleRateUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="PaymentScheduleRateUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "PaymentScheduleRateUnitOfMeasure_enum_t")
@XmlEnum
public enum PaymentScheduleRateUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  PaymentScheduleRateUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static PaymentScheduleRateUnitOfMeasureEnumT fromValue(String v) {
    for (PaymentScheduleRateUnitOfMeasureEnumT c : PaymentScheduleRateUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
