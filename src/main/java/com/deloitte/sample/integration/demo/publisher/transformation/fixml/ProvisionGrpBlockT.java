...
/**
 * Java class for ProvisionGrp_Block_t complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="ProvisionGrp_Block_t">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;group ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}ProvisionGrpElements"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}ProvisionGrpAttributes"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class ProvisionGrpBlockT {

  @XmlElement(name = "BizCtr")
  protected List<ProvisionDateBusinessCenterGrpBlockT> bizCtr;

  @XmlElement(name = "CashSettlValDts")
  protected ProvisionCashSettlValueDatesBlockT cashSettlValDts;

  @XmlElement(name = "OptExerDts")
  protected ProvisionOptionExerciseDatesBlockT optExerDts;

  @XmlElement(name = "OptExpDt")
  protected ProvisionOptionExpirationDateBlockT optExpDt;

  @XmlElement(name = "OptRelvntUndlyDt")
  protected ProvisionOptionRelevantUnderlyingDateBlockT optRelvntUndlyDt;

  @XmlElement(name = "CashSettlPmtDts")
  protected ProvisionCashSettlPaymentDatesBlockT cashSettlPmtDts;

  @XmlElement(name = "CashSettlQteSrc")
  protected ProvisionCashSettlQuoteSourceBlockT cashSettlQteSrc;

  @XmlElement(name = "Pty")
  protected List<ProvisionPartiesBlockT> pty;
   ...
   * ProvisionDateBusinessCenterGrpBlockT }
   */
  public List<ProvisionDateBusinessCenterGrpBlockT> getBizCtr() {
    if (bizCtr == null) {
      bizCtr = new ArrayList<ProvisionDateBusinessCenterGrpBlockT>();
    }
    return this.bizCtr;
  }
   ...
   *
   * @return possible object is {@link ProvisionCashSettlValueDatesBlockT }
   */
  public ProvisionCashSettlValueDatesBlockT getCashSettlValDts() {
   ...
   *
   * @param value allowed object is {@link ProvisionCashSettlValueDatesBlockT }
   */
  public void setCashSettlValDts(ProvisionCashSettlValueDatesBlockT value) {
   ...
   *
   * @return possible object is {@link ProvisionOptionExerciseDatesBlockT }
   */
  public ProvisionOptionExerciseDatesBlockT getOptExerDts() {
    return optExerDts;
  }
   ...
   *
   * @param value allowed object is {@link ProvisionOptionExerciseDatesBlockT }
   */
  public void setOptExerDts(ProvisionOptionExerciseDatesBlockT value) {
   ...
   *
   * @return possible object is {@link ProvisionOptionExpirationDateBlockT }
   */
  public ProvisionOptionExpirationDateBlockT getOptExpDt() {
    return optExpDt;
  }
   ...
   *
   * @param value allowed object is {@link ProvisionOptionExpirationDateBlockT }
   */
  public void setOptExpDt(ProvisionOptionExpirationDateBlockT value) {
    this.optExpDt = value;
  }
   ...
   *
   * @return possible object is {@link ProvisionOptionRelevantUnderlyingDateBlockT }
   */
  public ProvisionOptionRelevantUnderlyingDateBlockT getOptRelvntUndlyDt() {
   ...
   *
   * @param value allowed object is {@link ProvisionOptionRelevantUnderlyingDateBlockT }
   */
  public void setOptRelvntUndlyDt(ProvisionOptionRelevantUnderlyingDateBlockT value) {
   ...
   *
   * @return possible object is {@link ProvisionCashSettlPaymentDatesBlockT }
   */
  public ProvisionCashSettlPaymentDatesBlockT getCashSettlPmtDts() {
   ...
   *
   * @param value allowed object is {@link ProvisionCashSettlPaymentDatesBlockT }
   */
  public void setCashSettlPmtDts(ProvisionCashSettlPaymentDatesBlockT value) {
   ...
   *
   * @return possible object is {@link ProvisionCashSettlQuoteSourceBlockT }
   */
  public ProvisionCashSettlQuoteSourceBlockT getCashSettlQteSrc() {
   ...
   *
   * @param value allowed object is {@link ProvisionCashSettlQuoteSourceBlockT }
   */
  public void setCashSettlQteSrc(ProvisionCashSettlQuoteSourceBlockT value) {
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link ProvisionPartiesBlockT }
   */
  public List<ProvisionPartiesBlockT> getPty() {
    if (pty == null) {
      pty = new ArrayList<ProvisionPartiesBlockT>();
    }
    return this.pty;
  }
