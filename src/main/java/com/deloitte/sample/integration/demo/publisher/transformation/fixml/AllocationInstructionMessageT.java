...
/**
 * AllocationInstruction can be found in Volume 5 of the specification
 *
...
@XmlType(
  name = "AllocationInstruction_message_t",
  propOrder = {
    "ordAlloc",
    "allExc",
    "instrmt",
...
public class AllocationInstructionMessageT extends AbstractMessageT {
