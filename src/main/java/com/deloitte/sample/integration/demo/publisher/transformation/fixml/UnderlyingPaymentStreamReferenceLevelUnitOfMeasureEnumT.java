...
/**
 * Java class for UnderlyingPaymentStreamReferenceLevelUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="UnderlyingPaymentStreamReferenceLevelUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "UnderlyingPaymentStreamReferenceLevelUnitOfMeasure_enum_t")
@XmlEnum
public enum UnderlyingPaymentStreamReferenceLevelUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  UnderlyingPaymentStreamReferenceLevelUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static UnderlyingPaymentStreamReferenceLevelUnitOfMeasureEnumT fromValue(String v) {
    for (UnderlyingPaymentStreamReferenceLevelUnitOfMeasureEnumT c :
        UnderlyingPaymentStreamReferenceLevelUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
