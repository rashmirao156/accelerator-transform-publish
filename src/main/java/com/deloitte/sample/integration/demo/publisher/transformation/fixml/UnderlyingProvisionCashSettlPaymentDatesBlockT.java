...
/**
 * Java class for UnderlyingProvisionCashSettlPaymentDates_Block_t complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="UnderlyingProvisionCashSettlPaymentDates_Block_t">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;group ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}UnderlyingProvisionCashSettlPaymentDatesElements"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}UnderlyingProvisionCashSettlPaymentDatesAttributes"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(
  name = "UnderlyingProvisionCashSettlPaymentDates_Block_t",
  propOrder = {"bizCtr", "cashSettlPmtFixedDt"}
)
public class UnderlyingProvisionCashSettlPaymentDatesBlockT {

  @XmlElement(name = "BizCtr")
  protected List<UnderlyingProvisionCashSettlPaymentDateBusinessCenterGrpBlockT> bizCtr;

  @XmlElement(name = "CashSettlPmtFixedDt")
  protected List<UnderlyingProvisionCashSettlPaymentFixedDateGrpBlockT> cashSettlPmtFixedDt;
   ...
   * UnderlyingProvisionCashSettlPaymentDateBusinessCenterGrpBlockT }
   */
  public List<UnderlyingProvisionCashSettlPaymentDateBusinessCenterGrpBlockT> getBizCtr() {
    if (bizCtr == null) {
      bizCtr = new ArrayList<UnderlyingProvisionCashSettlPaymentDateBusinessCenterGrpBlockT>();
    }
    return this.bizCtr;
  }
   ...
   *
   * <p>Objects of the following type(s) are allowed in the list {@link
   * UnderlyingProvisionCashSettlPaymentFixedDateGrpBlockT }
   */
  public List<UnderlyingProvisionCashSettlPaymentFixedDateGrpBlockT> getCashSettlPmtFixedDt() {
    if (cashSettlPmtFixedDt == null) {
      cashSettlPmtFixedDt = new ArrayList<UnderlyingProvisionCashSettlPaymentFixedDateGrpBlockT>();
    }
