...
/**
 * Java class for AllocCommissionUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="AllocCommissionUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "AllocCommissionUnitOfMeasure_enum_t")
@XmlEnum
public enum AllocCommissionUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  AllocCommissionUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static AllocCommissionUnitOfMeasureEnumT fromValue(String v) {
    for (AllocCommissionUnitOfMeasureEnumT c : AllocCommissionUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
