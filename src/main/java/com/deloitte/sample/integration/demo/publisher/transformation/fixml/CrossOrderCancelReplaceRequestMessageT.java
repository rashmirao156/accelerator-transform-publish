...
/**
 * CrossOrderCancelReplaceRequest can be found in Volume 4 of the specification
 *
...
@XmlType(
  name = "CrossOrderCancelReplaceRequest_message_t",
  propOrder = {
    "pty",
    "sideCrossMod",
    "instrmt",
...
public class CrossOrderCancelReplaceRequestMessageT extends AbstractMessageT {
