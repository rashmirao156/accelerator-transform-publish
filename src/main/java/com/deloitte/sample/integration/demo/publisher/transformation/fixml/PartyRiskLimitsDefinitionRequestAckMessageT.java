...
/**
 * PartyRiskLimitsDefinitionRequestAck can be found in Volume 3 of the specification
 *
 ...
 *       &lt;sequence>
 *         &lt;group ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}PartyRiskLimitsDefinitionRequestAckElements"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}PartyRiskLimitsDefinitionRequestAckAttributes"/>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(
  name = "PartyRiskLimitsDefinitionRequestAck_message_t",
  propOrder = {"reqPty", "ptyRiskLmtAck"}
)
public class PartyRiskLimitsDefinitionRequestAckMessageT extends AbstractMessageT {
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the ptyRiskLmtAck property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link PartyRiskLimitsAckGrpBlockT
   * }
   */
