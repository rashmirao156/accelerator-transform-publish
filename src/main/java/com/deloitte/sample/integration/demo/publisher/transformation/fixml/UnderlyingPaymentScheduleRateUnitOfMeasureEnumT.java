...
/**
 * Java class for UnderlyingPaymentScheduleRateUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="UnderlyingPaymentScheduleRateUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "UnderlyingPaymentScheduleRateUnitOfMeasure_enum_t")
@XmlEnum
public enum UnderlyingPaymentScheduleRateUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  UnderlyingPaymentScheduleRateUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static UnderlyingPaymentScheduleRateUnitOfMeasureEnumT fromValue(String v) {
    for (UnderlyingPaymentScheduleRateUnitOfMeasureEnumT c :
        UnderlyingPaymentScheduleRateUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
