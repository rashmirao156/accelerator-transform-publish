...
/**
 * Java class for SettlRateDisruptionFallbackGrp_Block_t complex type.
 *
...
@XmlType(
  name = "SettlRateDisruptionFallbackGrp_Block_t",
  propOrder = {"rtSrc"}
)
public class SettlRateDisruptionFallbackGrpBlockT {
   ...
   *
   * @return possible object is {@link SettlRateFallbackRateSourceBlockT }
   */
   ...
   *
   * @param value allowed object is {@link SettlRateFallbackRateSourceBlockT }
   */
