...
/**
 * Java class for StreamCommoditySettlPeriodNotionalUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="StreamCommoditySettlPeriodNotionalUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "StreamCommoditySettlPeriodNotionalUnitOfMeasure_enum_t")
@XmlEnum
public enum StreamCommoditySettlPeriodNotionalUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  StreamCommoditySettlPeriodNotionalUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static StreamCommoditySettlPeriodNotionalUnitOfMeasureEnumT fromValue(String v) {
    for (StreamCommoditySettlPeriodNotionalUnitOfMeasureEnumT c :
        StreamCommoditySettlPeriodNotionalUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
