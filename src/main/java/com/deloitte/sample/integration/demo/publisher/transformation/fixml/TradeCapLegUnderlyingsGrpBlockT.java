...
/**
 * Java class for TradeCapLegUnderlyingsGrp_Block_t complex type.
 *
...
@XmlType(
  name = "TradeCapLegUnderlyingsGrp_Block_t",
  propOrder = {"instrmt"}
)
public class TradeCapLegUnderlyingsGrpBlockT {
   ...
   *
   * @return possible object is {@link UnderlyingLegInstrumentBlockT }
   */
   ...
   *
   * @param value allowed object is {@link UnderlyingLegInstrumentBlockT }
   */
