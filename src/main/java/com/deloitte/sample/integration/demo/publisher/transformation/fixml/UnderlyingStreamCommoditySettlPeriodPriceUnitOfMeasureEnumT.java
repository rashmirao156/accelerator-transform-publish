...
/**
 * Java class for UnderlyingStreamCommoditySettlPeriodPriceUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="UnderlyingStreamCommoditySettlPeriodPriceUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "UnderlyingStreamCommoditySettlPeriodPriceUnitOfMeasure_enum_t")
@XmlEnum
public enum UnderlyingStreamCommoditySettlPeriodPriceUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  UnderlyingStreamCommoditySettlPeriodPriceUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static UnderlyingStreamCommoditySettlPeriodPriceUnitOfMeasureEnumT fromValue(String v) {
    for (UnderlyingStreamCommoditySettlPeriodPriceUnitOfMeasureEnumT c :
        UnderlyingStreamCommoditySettlPeriodPriceUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
