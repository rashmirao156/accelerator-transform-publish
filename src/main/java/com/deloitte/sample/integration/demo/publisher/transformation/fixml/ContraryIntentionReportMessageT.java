...
/**
 * ContraryIntentionReport can be found in Volume 5 of the specification
 *
...
@XmlType(
  name = "ContraryIntentionReport_message_t",
  propOrder = {"applSeqCtrl", "pty", "qty", "instrmt", "undly"}
)
public class ContraryIntentionReportMessageT extends AbstractMessageT {
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link ExpirationQtyBlockT }
   */
