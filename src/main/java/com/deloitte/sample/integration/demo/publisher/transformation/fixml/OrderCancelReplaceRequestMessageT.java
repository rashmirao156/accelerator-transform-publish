...
/**
 * OrderCancelReplaceRequest can be found in Volume 4 of the specification
 *
...
@XmlType(
  name = "OrderCancelReplaceRequest_message_t",
  propOrder = {
    "pty",
    "tgtPty",
    "preAll",
...
public class OrderCancelReplaceRequestMessageT extends AbstractMessageT {
