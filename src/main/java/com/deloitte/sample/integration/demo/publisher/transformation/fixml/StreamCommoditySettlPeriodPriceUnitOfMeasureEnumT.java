...
/**
 * Java class for StreamCommoditySettlPeriodPriceUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="StreamCommoditySettlPeriodPriceUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "StreamCommoditySettlPeriodPriceUnitOfMeasure_enum_t")
@XmlEnum
public enum StreamCommoditySettlPeriodPriceUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  StreamCommoditySettlPeriodPriceUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static StreamCommoditySettlPeriodPriceUnitOfMeasureEnumT fromValue(String v) {
    for (StreamCommoditySettlPeriodPriceUnitOfMeasureEnumT c :
        StreamCommoditySettlPeriodPriceUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
