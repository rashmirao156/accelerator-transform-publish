...
/**
 * Java class for OptionExerciseDates_Block_t complex type.
 *
...
@XmlType(
  name = "OptionExerciseDates_Block_t",
  propOrder = {"bizCtr", "dt"}
)
public class OptionExerciseDatesBlockT {
   ...
   * OptionExerciseBusinessCenterGrpBlockT }
   */
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link OptionExerciseDateGrpBlockT
   * }
   */
