...
/**
 * Java class for UnderlyingDeliveryScheduleToleranceUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="UnderlyingDeliveryScheduleToleranceUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "UnderlyingDeliveryScheduleToleranceUnitOfMeasure_enum_t")
@XmlEnum
public enum UnderlyingDeliveryScheduleToleranceUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  UnderlyingDeliveryScheduleToleranceUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static UnderlyingDeliveryScheduleToleranceUnitOfMeasureEnumT fromValue(String v) {
    for (UnderlyingDeliveryScheduleToleranceUnitOfMeasureEnumT c :
        UnderlyingDeliveryScheduleToleranceUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
