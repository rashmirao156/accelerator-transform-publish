...
/**
 * Java class for PosQtyUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="PosQtyUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "PosQtyUnitOfMeasure_enum_t")
@XmlEnum
public enum PosQtyUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  PosQtyUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static PosQtyUnitOfMeasureEnumT fromValue(String v) {
    for (PosQtyUnitOfMeasureEnumT c : PosQtyUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
