...
/**
 * Java class for DeliveryScheduleToleranceUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="DeliveryScheduleToleranceUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "DeliveryScheduleToleranceUnitOfMeasure_enum_t")
@XmlEnum
public enum DeliveryScheduleToleranceUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  DeliveryScheduleToleranceUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static DeliveryScheduleToleranceUnitOfMeasureEnumT fromValue(String v) {
    for (DeliveryScheduleToleranceUnitOfMeasureEnumT c :
        DeliveryScheduleToleranceUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
