...
/**
 * Java class for PaymentStreamFixedAmountUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="PaymentStreamFixedAmountUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "PaymentStreamFixedAmountUnitOfMeasure_enum_t")
@XmlEnum
public enum PaymentStreamFixedAmountUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  PaymentStreamFixedAmountUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static PaymentStreamFixedAmountUnitOfMeasureEnumT fromValue(String v) {
    for (PaymentStreamFixedAmountUnitOfMeasureEnumT c :
        PaymentStreamFixedAmountUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
