...
/**
 * PartyDetailsListReport can be found in Volume 3 of the specification
 *
...
@XmlType(
  name = "PartyDetailsListReport_message_t",
  propOrder = {"applSeqCtrl", "ptyDetl"}
)
public class PartyDetailsListReportMessageT extends AbstractMessageT {
