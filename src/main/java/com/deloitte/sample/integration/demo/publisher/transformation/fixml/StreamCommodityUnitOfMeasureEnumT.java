...
/**
 * Java class for StreamCommodityUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="StreamCommodityUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "StreamCommodityUnitOfMeasure_enum_t")
@XmlEnum
public enum StreamCommodityUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  StreamCommodityUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static StreamCommodityUnitOfMeasureEnumT fromValue(String v) {
    for (StreamCommodityUnitOfMeasureEnumT c : StreamCommodityUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
