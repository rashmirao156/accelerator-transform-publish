...
/**
 * PositionTransferReport can be found in Volume 5 of the specification
 *
...
@XmlType(
  name = "PositionTransferReport_message_t",
  propOrder = {"pty", "tgtPty", "instrmt", "undly", "qty", "amt"}
)
public class PositionTransferReportMessageT extends AbstractMessageT {
