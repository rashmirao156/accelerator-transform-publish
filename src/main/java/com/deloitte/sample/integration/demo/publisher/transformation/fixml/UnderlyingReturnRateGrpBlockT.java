...
/**
 * Java class for UnderlyingReturnRateGrp_Block_t complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="UnderlyingReturnRateGrp_Block_t">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;group ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}UnderlyingReturnRateGrpElements"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}UnderlyingReturnRateGrpAttributes"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(
  name = "UnderlyingReturnRateGrp_Block_t",
  propOrder = {"px", "fxCnvrsn", "infoSrc", "dt"}
)
public class UnderlyingReturnRateGrpBlockT {

  @XmlElement(name = "Px")
  protected List<UnderlyingReturnRatePriceGrpBlockT> px;

  @XmlElement(name = "FxCnvrsn")
  protected List<UnderlyingReturnRateFXConversionGrpBlockT> fxCnvrsn;

  @XmlElement(name = "InfoSrc")
  protected List<UnderlyingReturnRateInformationSourceGrpBlockT> infoSrc;

  @XmlElement(name = "Dt")
  protected List<UnderlyingReturnRateDateGrpBlockT> dt;
   ...
   * UnderlyingReturnRatePriceGrpBlockT }
   */
  public List<UnderlyingReturnRatePriceGrpBlockT> getPx() {
    if (px == null) {
      px = new ArrayList<UnderlyingReturnRatePriceGrpBlockT>();
    }
    return this.px;
  }
   ...
   *
   * <p>Objects of the following type(s) are allowed in the list {@link
   * UnderlyingReturnRateFXConversionGrpBlockT }
   */
  public List<UnderlyingReturnRateFXConversionGrpBlockT> getFxCnvrsn() {
    if (fxCnvrsn == null) {
      fxCnvrsn = new ArrayList<UnderlyingReturnRateFXConversionGrpBlockT>();
    }
   ...
   *
   * <p>Objects of the following type(s) are allowed in the list {@link
   * UnderlyingReturnRateInformationSourceGrpBlockT }
   */
  public List<UnderlyingReturnRateInformationSourceGrpBlockT> getInfoSrc() {
    if (infoSrc == null) {
      infoSrc = new ArrayList<UnderlyingReturnRateInformationSourceGrpBlockT>();
    }
    return this.infoSrc;
  }
   ...
   *
   * <p>Objects of the following type(s) are allowed in the list {@link
   * UnderlyingReturnRateDateGrpBlockT }
   */
  public List<UnderlyingReturnRateDateGrpBlockT> getDt() {
    if (dt == null) {
      dt = new ArrayList<UnderlyingReturnRateDateGrpBlockT>();
    }
    return this.dt;
  }
