...
/**
 * Java class for PaymentStreamRateIndexUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="PaymentStreamRateIndexUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "PaymentStreamRateIndexUnitOfMeasure_enum_t")
@XmlEnum
public enum PaymentStreamRateIndexUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  PaymentStreamRateIndexUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static PaymentStreamRateIndexUnitOfMeasureEnumT fromValue(String v) {
    for (PaymentStreamRateIndexUnitOfMeasureEnumT c :
        PaymentStreamRateIndexUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
