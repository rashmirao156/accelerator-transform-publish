...
/**
 * MarketDataRequestReject can be found in Volume 3 of the specification
 *
...
@XmlType(
  name = "MarketDataRequestReject_message_t",
  propOrder = {"pty", "rjct"}
)
public class MarketDataRequestRejectMessageT extends AbstractMessageT {
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the rjct property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link MDRjctGrpBlockT }
   */
