...
/**
 * Java class for UnderlyingStreamNotionalUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="UnderlyingStreamNotionalUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "UnderlyingStreamNotionalUnitOfMeasure_enum_t")
@XmlEnum
public enum UnderlyingStreamNotionalUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  UnderlyingStreamNotionalUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static UnderlyingStreamNotionalUnitOfMeasureEnumT fromValue(String v) {
    for (UnderlyingStreamNotionalUnitOfMeasureEnumT c :
        UnderlyingStreamNotionalUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
