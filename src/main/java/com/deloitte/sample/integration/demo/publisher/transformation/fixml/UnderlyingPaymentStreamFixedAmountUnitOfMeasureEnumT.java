...
/**
 * Java class for UnderlyingPaymentStreamFixedAmountUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="UnderlyingPaymentStreamFixedAmountUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "UnderlyingPaymentStreamFixedAmountUnitOfMeasure_enum_t")
@XmlEnum
public enum UnderlyingPaymentStreamFixedAmountUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  UnderlyingPaymentStreamFixedAmountUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static UnderlyingPaymentStreamFixedAmountUnitOfMeasureEnumT fromValue(String v) {
    for (UnderlyingPaymentStreamFixedAmountUnitOfMeasureEnumT c :
        UnderlyingPaymentStreamFixedAmountUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
