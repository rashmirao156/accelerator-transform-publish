...
/**
 * Java class for UnderlyingPaymentStreamPaymentDates_Block_t complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="UnderlyingPaymentStreamPaymentDates_Block_t">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;group ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}UnderlyingPaymentStreamPaymentDatesElements"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}UnderlyingPaymentStreamPaymentDatesAttributes"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(
  name = "UnderlyingPaymentStreamPaymentDates_Block_t",
  propOrder = {"bizCtr", "pmtDt", "fnlPxPmt"}
)
public class UnderlyingPaymentStreamPaymentDatesBlockT {

  @XmlElement(name = "BizCtr")
  protected List<UnderlyingPaymentStreamPaymentDateBusinessCenterGrpBlockT> bizCtr;

  @XmlElement(name = "PmtDt")
  protected List<UnderlyingPaymentStreamPaymentDateGrpBlockT> pmtDt;

  @XmlElement(name = "FnlPxPmt")
  protected UnderlyingPaymentStreamFinalPricePaymentDateBlockT fnlPxPmt;
   ...
   * UnderlyingPaymentStreamPaymentDateBusinessCenterGrpBlockT }
   */
  public List<UnderlyingPaymentStreamPaymentDateBusinessCenterGrpBlockT> getBizCtr() {
    if (bizCtr == null) {
      bizCtr = new ArrayList<UnderlyingPaymentStreamPaymentDateBusinessCenterGrpBlockT>();
    }
    return this.bizCtr;
  }
   ...
   *
   * <p>Objects of the following type(s) are allowed in the list {@link
   * UnderlyingPaymentStreamPaymentDateGrpBlockT }
   */
  public List<UnderlyingPaymentStreamPaymentDateGrpBlockT> getPmtDt() {
    if (pmtDt == null) {
      pmtDt = new ArrayList<UnderlyingPaymentStreamPaymentDateGrpBlockT>();
    }
    return this.pmtDt;
  }
   ...
   *
   * @return possible object is {@link UnderlyingPaymentStreamFinalPricePaymentDateBlockT }
   */
  public UnderlyingPaymentStreamFinalPricePaymentDateBlockT getFnlPxPmt() {
    return fnlPxPmt;
  }
   ...
   *
   * @param value allowed object is {@link UnderlyingPaymentStreamFinalPricePaymentDateBlockT }
   */
  public void setFnlPxPmt(UnderlyingPaymentStreamFinalPricePaymentDateBlockT value) {
    this.fnlPxPmt = value;
  }
