...
/**
 * MultilegOrderCancelReplace can be found in Volume 4 of the specification
 *
...
@XmlType(
  name = "MultilegOrderCancelReplace_message_t",
  propOrder = {
    "pty",
    "tgtPty",
    "preAllocMleg",
...
public class MultilegOrderCancelReplaceMessageT extends AbstractMessageT {
