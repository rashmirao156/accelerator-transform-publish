...
/**
 * Java class for PaymentUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="PaymentUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "PaymentUnitOfMeasure_enum_t")
@XmlEnum
public enum PaymentUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  PaymentUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static PaymentUnitOfMeasureEnumT fromValue(String v) {
    for (PaymentUnitOfMeasureEnumT c : PaymentUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
