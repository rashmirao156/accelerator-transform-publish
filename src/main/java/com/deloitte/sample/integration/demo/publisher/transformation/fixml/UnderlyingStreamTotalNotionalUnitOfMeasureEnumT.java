...
/**
 * Java class for UnderlyingStreamTotalNotionalUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="UnderlyingStreamTotalNotionalUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "UnderlyingStreamTotalNotionalUnitOfMeasure_enum_t")
@XmlEnum
public enum UnderlyingStreamTotalNotionalUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  UnderlyingStreamTotalNotionalUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static UnderlyingStreamTotalNotionalUnitOfMeasureEnumT fromValue(String v) {
    for (UnderlyingStreamTotalNotionalUnitOfMeasureEnumT c :
        UnderlyingStreamTotalNotionalUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
