...
/**
 * Java class for LegPaymentScheduleStepUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="LegPaymentScheduleStepUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "LegPaymentScheduleStepUnitOfMeasure_enum_t")
@XmlEnum
public enum LegPaymentScheduleStepUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  LegPaymentScheduleStepUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static LegPaymentScheduleStepUnitOfMeasureEnumT fromValue(String v) {
    for (LegPaymentScheduleStepUnitOfMeasureEnumT c :
        LegPaymentScheduleStepUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
