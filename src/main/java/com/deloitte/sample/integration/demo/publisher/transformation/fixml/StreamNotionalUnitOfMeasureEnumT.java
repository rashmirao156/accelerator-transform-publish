...
/**
 * Java class for StreamNotionalUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="StreamNotionalUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "StreamNotionalUnitOfMeasure_enum_t")
@XmlEnum
public enum StreamNotionalUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  StreamNotionalUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static StreamNotionalUnitOfMeasureEnumT fromValue(String v) {
    for (StreamNotionalUnitOfMeasureEnumT c : StreamNotionalUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
