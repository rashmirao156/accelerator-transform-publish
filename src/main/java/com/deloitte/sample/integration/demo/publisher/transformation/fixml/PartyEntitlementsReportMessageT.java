...
/**
 * PartyEntitlementsReport can be found in Volume 3 of the specification
 *
 * <p>Java class for PartyEntitlementsReport_message_t complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="PartyEntitlementsReport_message_t">
 *   &lt;complexContent>
 *     &lt;extension base="{http://www.fixprotocol.org/FIXML-5-0-SP2}Abstract_message_t">
 *       &lt;sequence>
 *         &lt;group ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}PartyEntitlementsReportElements"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}PartyEntitlementsReportAttributes"/>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(
  name = "PartyEntitlementsReport_message_t",
  propOrder = {"applSeqCtrl", "ptyEntlmnt"}
)
public class PartyEntitlementsReportMessageT extends AbstractMessageT {

  @XmlElement(name = "ApplSeqCtrl")
  protected ApplicationSequenceControlBlockT applSeqCtrl;

  @XmlElement(name = "PtyEntlmnt")
  protected List<PartyEntitlementGrpBlockT> ptyEntlmnt;
  ...
  /**
   * Gets the value of the ptyEntlmnt property.
   *
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the ptyEntlmnt property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   *    getPtyEntlmnt().add(newItem);
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link PartyEntitlementGrpBlockT }
   */
  public List<PartyEntitlementGrpBlockT> getPtyEntlmnt() {
    if (ptyEntlmnt == null) {
      ptyEntlmnt = new ArrayList<PartyEntitlementGrpBlockT>();
    }
    return this.ptyEntlmnt;
  }
