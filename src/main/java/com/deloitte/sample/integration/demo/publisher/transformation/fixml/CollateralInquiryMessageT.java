...
/**
 * CollateralInquiry can be found in Volume 5 of the specification
 *
...
@XmlType(
  name = "CollateralInquiry_message_t",
  propOrder = {
    "qual",
    "pty",
    "collExc",
...
public class CollateralInquiryMessageT extends AbstractMessageT {
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link CollInqQualGrpBlockT }
   */
