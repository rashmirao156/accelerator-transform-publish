...
/**
 * Java class for ComplexEventDates_Block_t complex type.
 *
...
@XmlType(
  name = "ComplexEventDates_Block_t",
  propOrder = {"evntTms"}
)
public class ComplexEventDatesBlockT {
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link ComplexEventTimesBlockT }
   */
