...
/**
 * Java class for LegPaymentScheduleSettlPeriodPriceUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="LegPaymentScheduleSettlPeriodPriceUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "LegPaymentScheduleSettlPeriodPriceUnitOfMeasure_enum_t")
@XmlEnum
public enum LegPaymentScheduleSettlPeriodPriceUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  LegPaymentScheduleSettlPeriodPriceUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static LegPaymentScheduleSettlPeriodPriceUnitOfMeasureEnumT fromValue(String v) {
    for (LegPaymentScheduleSettlPeriodPriceUnitOfMeasureEnumT c :
        LegPaymentScheduleSettlPeriodPriceUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
