...
/**
 * Java class for StreamTotalNotionalUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="StreamTotalNotionalUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "StreamTotalNotionalUnitOfMeasure_enum_t")
@XmlEnum
public enum StreamTotalNotionalUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  StreamTotalNotionalUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static StreamTotalNotionalUnitOfMeasureEnumT fromValue(String v) {
    for (StreamTotalNotionalUnitOfMeasureEnumT c : StreamTotalNotionalUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
