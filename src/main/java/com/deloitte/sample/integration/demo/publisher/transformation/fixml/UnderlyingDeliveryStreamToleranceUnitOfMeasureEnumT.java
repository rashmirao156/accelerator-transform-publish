...
/**
 * Java class for UnderlyingDeliveryStreamToleranceUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="UnderlyingDeliveryStreamToleranceUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "UnderlyingDeliveryStreamToleranceUnitOfMeasure_enum_t")
@XmlEnum
public enum UnderlyingDeliveryStreamToleranceUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  UnderlyingDeliveryStreamToleranceUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static UnderlyingDeliveryStreamToleranceUnitOfMeasureEnumT fromValue(String v) {
    for (UnderlyingDeliveryStreamToleranceUnitOfMeasureEnumT c :
        UnderlyingDeliveryStreamToleranceUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
