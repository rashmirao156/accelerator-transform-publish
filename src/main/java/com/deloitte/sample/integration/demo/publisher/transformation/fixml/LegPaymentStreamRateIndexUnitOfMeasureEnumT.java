...
/**
 * Java class for LegPaymentStreamRateIndexUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="LegPaymentStreamRateIndexUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "LegPaymentStreamRateIndexUnitOfMeasure_enum_t")
@XmlEnum
public enum LegPaymentStreamRateIndexUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  LegPaymentStreamRateIndexUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static LegPaymentStreamRateIndexUnitOfMeasureEnumT fromValue(String v) {
    for (LegPaymentStreamRateIndexUnitOfMeasureEnumT c :
        LegPaymentStreamRateIndexUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
