...
/**
 * SecurityList can be found in Volume 3 of the specification
 *
...
@XmlType(
  name = "SecurityList_message_t",
  propOrder = {"applSeqCtrl", "secL"}
)
public class SecurityListMessageT extends AbstractMessageT {
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link SecListGrpBlockT }
   */
