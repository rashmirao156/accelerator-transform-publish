...
/**
 * Java class for SettlPriceUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="SettlPriceUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "SettlPriceUnitOfMeasure_enum_t")
@XmlEnum
public enum SettlPriceUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  SettlPriceUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static SettlPriceUnitOfMeasureEnumT fromValue(String v) {
    for (SettlPriceUnitOfMeasureEnumT c : SettlPriceUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
