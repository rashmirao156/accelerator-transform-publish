...
/**
 * Java class for LegDeliveryStreamToleranceUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="LegDeliveryStreamToleranceUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "LegDeliveryStreamToleranceUnitOfMeasure_enum_t")
@XmlEnum
public enum LegDeliveryStreamToleranceUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  LegDeliveryStreamToleranceUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static LegDeliveryStreamToleranceUnitOfMeasureEnumT fromValue(String v) {
    for (LegDeliveryStreamToleranceUnitOfMeasureEnumT c :
        LegDeliveryStreamToleranceUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
