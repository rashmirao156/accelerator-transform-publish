...
/**
 * Java class for PaymentStreamRateSpreadUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="PaymentStreamRateSpreadUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "PaymentStreamRateSpreadUnitOfMeasure_enum_t")
@XmlEnum
public enum PaymentStreamRateSpreadUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  PaymentStreamRateSpreadUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static PaymentStreamRateSpreadUnitOfMeasureEnumT fromValue(String v) {
    for (PaymentStreamRateSpreadUnitOfMeasureEnumT c :
        PaymentStreamRateSpreadUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
