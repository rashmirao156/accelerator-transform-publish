...
/**
 * Java class for UnderlyingPaymentStreamRateIndexUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="UnderlyingPaymentStreamRateIndexUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "UnderlyingPaymentStreamRateIndexUnitOfMeasure_enum_t")
@XmlEnum
public enum UnderlyingPaymentStreamRateIndexUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  UnderlyingPaymentStreamRateIndexUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static UnderlyingPaymentStreamRateIndexUnitOfMeasureEnumT fromValue(String v) {
    for (UnderlyingPaymentStreamRateIndexUnitOfMeasureEnumT c :
        UnderlyingPaymentStreamRateIndexUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
