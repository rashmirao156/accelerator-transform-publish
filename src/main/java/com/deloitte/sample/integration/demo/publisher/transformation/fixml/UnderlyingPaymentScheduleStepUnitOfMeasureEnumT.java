...
/**
 * Java class for UnderlyingPaymentScheduleStepUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="UnderlyingPaymentScheduleStepUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "UnderlyingPaymentScheduleStepUnitOfMeasure_enum_t")
@XmlEnum
public enum UnderlyingPaymentScheduleStepUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  UnderlyingPaymentScheduleStepUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static UnderlyingPaymentScheduleStepUnitOfMeasureEnumT fromValue(String v) {
    for (UnderlyingPaymentScheduleStepUnitOfMeasureEnumT c :
        UnderlyingPaymentScheduleStepUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
