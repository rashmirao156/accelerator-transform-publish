...
/**
 * Java class for PaymentStreamCompoundingDates_Block_t complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="PaymentStreamCompoundingDates_Block_t">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;group ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}PaymentStreamCompoundingDatesElements"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}PaymentStreamCompoundingDatesAttributes"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(
  name = "PaymentStreamCompoundingDates_Block_t",
  propOrder = {"bizCtr", "cmpndgDt", "startDt", "endDt"}
)
public class PaymentStreamCompoundingDatesBlockT {

  @XmlElement(name = "BizCtr")
  protected List<PaymentStreamCompoundingDatesBusinessCenterGrpBlockT> bizCtr;

  @XmlElement(name = "CmpndgDt")
  protected PaymentStreamCompoundingDateGrpBlockT cmpndgDt;

  @XmlElement(name = "StartDt")
  protected PaymentStreamCompoundingStartDateBlockT startDt;

  @XmlElement(name = "EndDt")
  protected PaymentStreamCompoundingEndDateBlockT endDt;
   ...
   * PaymentStreamCompoundingDatesBusinessCenterGrpBlockT }
   */
  public List<PaymentStreamCompoundingDatesBusinessCenterGrpBlockT> getBizCtr() {
    if (bizCtr == null) {
      bizCtr = new ArrayList<PaymentStreamCompoundingDatesBusinessCenterGrpBlockT>();
    }
    return this.bizCtr;
  }
   ...
   *
   * @return possible object is {@link PaymentStreamCompoundingDateGrpBlockT }
   */
  public PaymentStreamCompoundingDateGrpBlockT getCmpndgDt() {
    return cmpndgDt;
  }
   ...
   *
   * @param value allowed object is {@link PaymentStreamCompoundingDateGrpBlockT }
   */
  public void setCmpndgDt(PaymentStreamCompoundingDateGrpBlockT value) {
    this.cmpndgDt = value;
  }
   ...
   *
   * @return possible object is {@link PaymentStreamCompoundingStartDateBlockT }
   */
  public PaymentStreamCompoundingStartDateBlockT getStartDt() {
    return startDt;
  }
   ...
   *
   * @param value allowed object is {@link PaymentStreamCompoundingStartDateBlockT }
   */
  public void setStartDt(PaymentStreamCompoundingStartDateBlockT value) {
    this.startDt = value;
  }
   ...
   *
   * @return possible object is {@link PaymentStreamCompoundingEndDateBlockT }
   */
  public PaymentStreamCompoundingEndDateBlockT getEndDt() {
    return endDt;
  }
   ...
   *
   * @param value allowed object is {@link PaymentStreamCompoundingEndDateBlockT }
   */
  public void setEndDt(PaymentStreamCompoundingEndDateBlockT value) {
    this.endDt = value;
  }
