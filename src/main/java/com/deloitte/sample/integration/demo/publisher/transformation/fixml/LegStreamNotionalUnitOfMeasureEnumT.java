...
/**
 * Java class for LegStreamNotionalUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="LegStreamNotionalUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "LegStreamNotionalUnitOfMeasure_enum_t")
@XmlEnum
public enum LegStreamNotionalUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  LegStreamNotionalUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static LegStreamNotionalUnitOfMeasureEnumT fromValue(String v) {
    for (LegStreamNotionalUnitOfMeasureEnumT c : LegStreamNotionalUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
