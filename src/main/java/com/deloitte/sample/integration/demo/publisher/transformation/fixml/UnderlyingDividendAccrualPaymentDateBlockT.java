...
/**
 * Java class for UnderlyingDividendAccrualPaymentDate_Block_t complex type.
 *
...
@XmlType(
  name = "UnderlyingDividendAccrualPaymentDate_Block_t",
  propOrder = {"bizCtr"}
)
public class UnderlyingDividendAccrualPaymentDateBlockT {
   ...
   * UnderlyingDividendAccrualPaymentDateBusinessCenterGrpBlockT }
   */
