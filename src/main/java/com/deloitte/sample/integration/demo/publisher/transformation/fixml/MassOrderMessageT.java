...
/**
 * MassOrder can be found in Volume 4 of the specification
 *
 * <p>Java class for MassOrder_message_t complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="MassOrder_message_t">
 *   &lt;complexContent>
 *     &lt;extension base="{http://www.fixprotocol.org/FIXML-5-0-SP2}Abstract_message_t">
 *       &lt;sequence>
 *         &lt;group ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}MassOrderElements"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}MassOrderAttributes"/>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(
  name = "MassOrder_message_t",
  propOrder = {"pty", "orderEntry"}
)
public class MassOrderMessageT extends AbstractMessageT {

  @XmlElement(name = "Pty")
  protected List<PartiesBlockT> pty;

  @XmlElement(name = "OrderEntry", required = true)
  protected List<OrderEntryGrpBlockT> orderEntry;

  @XmlAttribute(name = "MassOrdReqID", required = true)
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the orderEntry property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link OrderEntryGrpBlockT }
   */
  public List<OrderEntryGrpBlockT> getOrderEntry() {
    if (orderEntry == null) {
      orderEntry = new ArrayList<OrderEntryGrpBlockT>();
    }
