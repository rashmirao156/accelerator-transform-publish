...
/**
 * Java class for LegPaymentStreamRateSpreadUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="LegPaymentStreamRateSpreadUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "LegPaymentStreamRateSpreadUnitOfMeasure_enum_t")
@XmlEnum
public enum LegPaymentStreamRateSpreadUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  LegPaymentStreamRateSpreadUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static LegPaymentStreamRateSpreadUnitOfMeasureEnumT fromValue(String v) {
    for (LegPaymentStreamRateSpreadUnitOfMeasureEnumT c :
        LegPaymentStreamRateSpreadUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
