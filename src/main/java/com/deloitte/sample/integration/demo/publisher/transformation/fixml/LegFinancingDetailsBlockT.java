...
/**
 * Java class for LegFinancingDetails_Block_t complex type.
 *
...
@XmlType(
  name = "LegFinancingDetails_Block_t",
...
public class LegFinancingDetailsBlockT {
   ...
   * LegFinancingContractualDefinitionsGrpBlockT }
   */
   ...
   *
   * <p>Objects of the following type(s) are allowed in the list {@link
   * LegFinancingTermSupplementGrpBlockT }
   */
   ...
   *
   * <p>Objects of the following type(s) are allowed in the list {@link
   * LegFinancingContractualMatrixGrpBlockT }
   */
