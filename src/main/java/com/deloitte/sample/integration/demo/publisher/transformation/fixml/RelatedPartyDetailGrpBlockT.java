...
/**
 * Java class for RelatedPartyDetailGrp_Block_t complex type.
 *
 ...
 *       &lt;sequence>
 *         &lt;group ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}RelatedPartyDetailGrpElements"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}RelatedPartyDetailGrpAttributes"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(
  name = "RelatedPartyDetailGrp_Block_t",
  propOrder = {"sub", "altPty", "rltnshp"}
)
public class RelatedPartyDetailGrpBlockT {
   ...
   * RelatedPartyDetailSubGrpBlockT }
   */
   ...
   *
   * <p>Objects of the following type(s) are allowed in the list {@link
   * RelatedPartyDetailAltIDGrpBlockT }
   */
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the rltnshp property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link PartyRelationshipGrpBlockT }
   */
