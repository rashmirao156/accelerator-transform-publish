...
/**
 * TradingSessionStatus can be found in Volume 3 of the specification
 *
...
@XmlType(
  name = "TradingSessionStatus_message_t",
  propOrder = {"applSeqCtrl", "instrmt"}
)
public class TradingSessionStatusMessageT extends AbstractMessageT {
  ...
  @XmlAttribute(name = "TrdgSesCtrl")
  protected BigInteger trdgSesCtrl;
  ...
  /**
   * Gets the value of the trdgSesCtrl property.
   *
   * @return possible object is {@link BigInteger }
   */
  public BigInteger getTrdgSesCtrl() {
    return trdgSesCtrl;
  }

  /**
   * Sets the value of the trdgSesCtrl property.
   *
   * @param value allowed object is {@link BigInteger }
   */
  public void setTrdgSesCtrl(BigInteger value) {
    this.trdgSesCtrl = value;
  }
