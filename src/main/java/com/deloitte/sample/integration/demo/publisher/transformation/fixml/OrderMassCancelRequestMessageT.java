...
/**
 * OrderMassCancelRequest can be found in Volume 4 of the specification
 *
...
@XmlType(
  name = "OrderMassCancelRequest_message_t",
  propOrder = {"pty", "tgtPty", "instrmt", "undly"}
)
public class OrderMassCancelRequestMessageT extends AbstractMessageT {
