...
/**
 * PartyRiskLimitsRequest can be found in Volume 3 of the specification
 *
 ...
 *       &lt;sequence>
 *         &lt;group ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}PartyRiskLimitsRequestElements"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}PartyRiskLimitsRequestAttributes"/>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(
  name = "PartyRiskLimitsRequest_message_t",
  propOrder = {"reqPty", "pty", "reqR", "reqRiskLmtTyp", "instrmtScope"}
)
public class PartyRiskLimitsRequestMessageT extends AbstractMessageT {
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the reqRiskLmtTyp property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   ...
   * RequestedRiskLimitTypesGrpBlockT }
   */
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link RiskInstrumentScopeGrpBlockT
   * }
   */
