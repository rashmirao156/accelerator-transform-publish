...
/**
 * SecurityListUpdateReport can be found in Volume 3 of the specification
 *
...
@XmlType(
  name = "SecurityListUpdateReport_message_t",
  propOrder = {"applSeqCtrl", "secL"}
)
public class SecurityListUpdateReportMessageT extends AbstractMessageT {
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link SecLstUpdRelSymGrpBlockT }
   */
