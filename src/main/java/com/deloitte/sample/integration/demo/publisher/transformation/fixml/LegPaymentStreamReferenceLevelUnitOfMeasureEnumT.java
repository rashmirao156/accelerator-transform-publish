...
/**
 * Java class for LegPaymentStreamReferenceLevelUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="LegPaymentStreamReferenceLevelUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "LegPaymentStreamReferenceLevelUnitOfMeasure_enum_t")
@XmlEnum
public enum LegPaymentStreamReferenceLevelUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  LegPaymentStreamReferenceLevelUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static LegPaymentStreamReferenceLevelUnitOfMeasureEnumT fromValue(String v) {
    for (LegPaymentStreamReferenceLevelUnitOfMeasureEnumT c :
        LegPaymentStreamReferenceLevelUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
