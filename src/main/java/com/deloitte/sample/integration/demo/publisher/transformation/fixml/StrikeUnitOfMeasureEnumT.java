...
/**
 * Java class for StrikeUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="StrikeUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "StrikeUnitOfMeasure_enum_t")
@XmlEnum
public enum StrikeUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  StrikeUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static StrikeUnitOfMeasureEnumT fromValue(String v) {
    for (StrikeUnitOfMeasureEnumT c : StrikeUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
