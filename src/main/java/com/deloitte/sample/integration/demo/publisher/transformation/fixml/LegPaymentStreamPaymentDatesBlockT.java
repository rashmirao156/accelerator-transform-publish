...
/**
 * Java class for LegPaymentStreamPaymentDates_Block_t complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="LegPaymentStreamPaymentDates_Block_t">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;group ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}LegPaymentStreamPaymentDatesElements"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}LegPaymentStreamPaymentDatesAttributes"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(
  name = "LegPaymentStreamPaymentDates_Block_t",
  propOrder = {"bizCtr", "pmtDt", "fnlPxPmt"}
)
public class LegPaymentStreamPaymentDatesBlockT {

  @XmlElement(name = "BizCtr")
  protected List<LegPaymentStreamPaymentDateBusinessCenterGrpBlockT> bizCtr;

  @XmlElement(name = "PmtDt")
  protected List<LegPaymentStreamPaymentDateGrpBlockT> pmtDt;

  @XmlElement(name = "FnlPxPmt")
  protected LegPaymentStreamFinalPricePaymentDateBlockT fnlPxPmt;
   ...
   * LegPaymentStreamPaymentDateBusinessCenterGrpBlockT }
   */
  public List<LegPaymentStreamPaymentDateBusinessCenterGrpBlockT> getBizCtr() {
    if (bizCtr == null) {
      bizCtr = new ArrayList<LegPaymentStreamPaymentDateBusinessCenterGrpBlockT>();
    }
    return this.bizCtr;
  }
   ...
   *
   * <p>Objects of the following type(s) are allowed in the list {@link
   * LegPaymentStreamPaymentDateGrpBlockT }
   */
  public List<LegPaymentStreamPaymentDateGrpBlockT> getPmtDt() {
    if (pmtDt == null) {
      pmtDt = new ArrayList<LegPaymentStreamPaymentDateGrpBlockT>();
    }
    return this.pmtDt;
  }
   ...
   *
   * @return possible object is {@link LegPaymentStreamFinalPricePaymentDateBlockT }
   */
  public LegPaymentStreamFinalPricePaymentDateBlockT getFnlPxPmt() {
    return fnlPxPmt;
  }
   ...
   *
   * @param value allowed object is {@link LegPaymentStreamFinalPricePaymentDateBlockT }
   */
  public void setFnlPxPmt(LegPaymentStreamFinalPricePaymentDateBlockT value) {
    this.fnlPxPmt = value;
  }
