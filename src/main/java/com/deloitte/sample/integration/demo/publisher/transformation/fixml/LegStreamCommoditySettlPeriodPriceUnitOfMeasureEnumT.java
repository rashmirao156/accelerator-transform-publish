...
/**
 * Java class for LegStreamCommoditySettlPeriodPriceUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="LegStreamCommoditySettlPeriodPriceUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "LegStreamCommoditySettlPeriodPriceUnitOfMeasure_enum_t")
@XmlEnum
public enum LegStreamCommoditySettlPeriodPriceUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  LegStreamCommoditySettlPeriodPriceUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static LegStreamCommoditySettlPeriodPriceUnitOfMeasureEnumT fromValue(String v) {
    for (LegStreamCommoditySettlPeriodPriceUnitOfMeasureEnumT c :
        LegStreamCommoditySettlPeriodPriceUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
