...
/**
 * SecurityDefinitionUpdateReport can be found in Volume 3 of the specification
 *
...
@XmlType(
  name = "SecurityDefinitionUpdateReport_message_t",
  propOrder = {
    "applSeqCtrl",
    "instrmt",
    "instrmtExt",
...
public class SecurityDefinitionUpdateReportMessageT extends AbstractMessageT {
