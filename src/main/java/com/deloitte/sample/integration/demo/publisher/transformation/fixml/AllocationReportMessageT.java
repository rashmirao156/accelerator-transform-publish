...
/**
 * AllocationReport can be found in Volume 5 of the specification
 *
...
@XmlType(
  name = "AllocationReport_message_t",
  propOrder = {
    "ordAlloc",
    "allExc",
    "instrmt",
...
public class AllocationReportMessageT extends AbstractMessageT {
  ...
  @XmlAttribute(name = "RvrslStat")
  protected BigInteger rvrslStat;
  ...
  /**
   * Gets the value of the rvrslStat property.
   *
   * @return possible object is {@link BigInteger }
   */
  public BigInteger getRvrslStat() {
    return rvrslStat;
  }

  /**
   * Sets the value of the rvrslStat property.
   *
   * @param value allowed object is {@link BigInteger }
   */
  public void setRvrslStat(BigInteger value) {
    this.rvrslStat = value;
  }
