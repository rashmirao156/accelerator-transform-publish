...
/**
 * Java class for PaymentScheduleStepUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="PaymentScheduleStepUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "PaymentScheduleStepUnitOfMeasure_enum_t")
@XmlEnum
public enum PaymentScheduleStepUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  PaymentScheduleStepUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static PaymentScheduleStepUnitOfMeasureEnumT fromValue(String v) {
    for (PaymentScheduleStepUnitOfMeasureEnumT c : PaymentScheduleStepUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
