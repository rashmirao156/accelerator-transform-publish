...
/**
 * Java class for UnderlyingPaymentStreamCompoundingDates_Block_t complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="UnderlyingPaymentStreamCompoundingDates_Block_t">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;group ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}UnderlyingPaymentStreamCompoundingDatesElements"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}UnderlyingPaymentStreamCompoundingDatesAttributes"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(
  name = "UnderlyingPaymentStreamCompoundingDates_Block_t",
  propOrder = {"bizCtr", "cmpndgDt", "startDt", "endDt"}
)
public class UnderlyingPaymentStreamCompoundingDatesBlockT {

  @XmlElement(name = "BizCtr")
  protected List<UnderlyingPaymentStreamCompoundingDatesBusinessCenterGrpBlockT> bizCtr;

  @XmlElement(name = "CmpndgDt")
  protected UnderlyingPaymentStreamCompoundingDateGrpBlockT cmpndgDt;

  @XmlElement(name = "StartDt")
  protected UnderlyingPaymentStreamCompoundingStartDateBlockT startDt;

  @XmlElement(name = "EndDt")
  protected UnderlyingPaymentStreamCompoundingEndDateBlockT endDt;
   ...
   * UnderlyingPaymentStreamCompoundingDatesBusinessCenterGrpBlockT }
   */
  public List<UnderlyingPaymentStreamCompoundingDatesBusinessCenterGrpBlockT> getBizCtr() {
    if (bizCtr == null) {
      bizCtr = new ArrayList<UnderlyingPaymentStreamCompoundingDatesBusinessCenterGrpBlockT>();
    }
    return this.bizCtr;
  }
   ...
   *
   * @return possible object is {@link UnderlyingPaymentStreamCompoundingDateGrpBlockT }
   */
  public UnderlyingPaymentStreamCompoundingDateGrpBlockT getCmpndgDt() {
    return cmpndgDt;
  }

  /**
   * Sets the value of the cmpndgDt property.
   *
   * @param value allowed object is {@link UnderlyingPaymentStreamCompoundingDateGrpBlockT }
   */
  public void setCmpndgDt(UnderlyingPaymentStreamCompoundingDateGrpBlockT value) {
    this.cmpndgDt = value;
  }
   ...
   *
   * @return possible object is {@link UnderlyingPaymentStreamCompoundingStartDateBlockT }
   */
  public UnderlyingPaymentStreamCompoundingStartDateBlockT getStartDt() {
    return startDt;
  }
   ...
   *
   * @param value allowed object is {@link UnderlyingPaymentStreamCompoundingStartDateBlockT }
   */
  public void setStartDt(UnderlyingPaymentStreamCompoundingStartDateBlockT value) {
    this.startDt = value;
  }
   ...
   *
   * @return possible object is {@link UnderlyingPaymentStreamCompoundingEndDateBlockT }
   */
  public UnderlyingPaymentStreamCompoundingEndDateBlockT getEndDt() {
    return endDt;
  }
   ...
   *
   * @param value allowed object is {@link UnderlyingPaymentStreamCompoundingEndDateBlockT }
   */
  public void setEndDt(UnderlyingPaymentStreamCompoundingEndDateBlockT value) {
    this.endDt = value;
  }
