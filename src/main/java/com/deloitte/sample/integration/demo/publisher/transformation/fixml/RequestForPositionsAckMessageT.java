...
/**
 * RequestForPositionsAck can be found in Volume 5 of the specification
 *
...
@XmlType(
  name = "RequestForPositionsAck_message_t",
  propOrder = {"pty", "instrmt", "leg", "undly"}
)
public class RequestForPositionsAckMessageT extends AbstractMessageT {
