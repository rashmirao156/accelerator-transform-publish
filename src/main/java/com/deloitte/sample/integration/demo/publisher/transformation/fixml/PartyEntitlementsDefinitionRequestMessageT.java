...
/**
 * PartyEntitlementsDefinitionRequest can be found in Volume 3 of the specification
 *
...
@XmlType(
  name = "PartyEntitlementsDefinitionRequest_message_t",
  propOrder = {"reqPty", "ptyEntlmntUpd"}
)
public class PartyEntitlementsDefinitionRequestMessageT extends AbstractMessageT {
