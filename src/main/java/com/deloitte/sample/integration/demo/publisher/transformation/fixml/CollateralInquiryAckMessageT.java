...
/**
 * CollateralInquiryAck can be found in Volume 5 of the specification
 *
...
@XmlType(
  name = "CollateralInquiryAck_message_t",
  propOrder = {"qual", "pty", "collExc", "trdColl", "instrmt", "finDetls", "leg", "undly"}
)
public class CollateralInquiryAckMessageT extends AbstractMessageT {
