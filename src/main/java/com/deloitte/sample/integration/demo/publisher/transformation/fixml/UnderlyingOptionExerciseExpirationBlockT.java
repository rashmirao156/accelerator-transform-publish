...
/**
 * Java class for UnderlyingOptionExerciseExpiration_Block_t complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="UnderlyingOptionExerciseExpiration_Block_t">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;group ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}UnderlyingOptionExerciseExpirationElements"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}UnderlyingOptionExerciseExpirationAttributes"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(
  name = "UnderlyingOptionExerciseExpiration_Block_t",
  propOrder = {"bizCtr", "dt"}
)
public class UnderlyingOptionExerciseExpirationBlockT {

  @XmlElement(name = "BizCtr")
  protected List<UnderlyingOptionExerciseExpirationDateBusinessCenterGrpBlockT> bizCtr;

  @XmlElement(name = "Dt")
  protected List<UnderlyingOptionExerciseExpirationDateGrpBlockT> dt;
   ...
   * UnderlyingOptionExerciseExpirationDateBusinessCenterGrpBlockT }
   */
  public List<UnderlyingOptionExerciseExpirationDateBusinessCenterGrpBlockT> getBizCtr() {
    if (bizCtr == null) {
      bizCtr = new ArrayList<UnderlyingOptionExerciseExpirationDateBusinessCenterGrpBlockT>();
    }
    return this.bizCtr;
  }
   ...
   *
   * <p>Objects of the following type(s) are allowed in the list {@link
   * UnderlyingOptionExerciseExpirationDateGrpBlockT }
   */
  public List<UnderlyingOptionExerciseExpirationDateGrpBlockT> getDt() {
    if (dt == null) {
      dt = new ArrayList<UnderlyingOptionExerciseExpirationDateGrpBlockT>();
    }
    return this.dt;
  }
