...
/**
 * Java class for LegReturnRateGrp_Block_t complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="LegReturnRateGrp_Block_t">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;group ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}LegReturnRateGrpElements"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}LegReturnRateGrpAttributes"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(
  name = "LegReturnRateGrp_Block_t",
  propOrder = {"px", "fxCnvrsn", "infoSrc", "dt"}
)
public class LegReturnRateGrpBlockT {

  @XmlElement(name = "Px")
  protected List<LegReturnRatePriceGrpBlockT> px;

  @XmlElement(name = "FxCnvrsn")
  protected List<LegReturnRateFXConversionGrpBlockT> fxCnvrsn;

  @XmlElement(name = "InfoSrc")
  protected List<LegReturnRateInformationSourceGrpBlockT> infoSrc;

  @XmlElement(name = "Dt")
  protected List<LegReturnRateDateGrpBlockT> dt;
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link LegReturnRatePriceGrpBlockT
   * }
   */
  public List<LegReturnRatePriceGrpBlockT> getPx() {
    if (px == null) {
      px = new ArrayList<LegReturnRatePriceGrpBlockT>();
    }
    return this.px;
  }
   ...
   * LegReturnRateFXConversionGrpBlockT }
   */
  public List<LegReturnRateFXConversionGrpBlockT> getFxCnvrsn() {
    if (fxCnvrsn == null) {
      fxCnvrsn = new ArrayList<LegReturnRateFXConversionGrpBlockT>();
    }
   ...
   *
   * <p>Objects of the following type(s) are allowed in the list {@link
   * LegReturnRateInformationSourceGrpBlockT }
   */
  public List<LegReturnRateInformationSourceGrpBlockT> getInfoSrc() {
    if (infoSrc == null) {
      infoSrc = new ArrayList<LegReturnRateInformationSourceGrpBlockT>();
    }
    return this.infoSrc;
  }
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link LegReturnRateDateGrpBlockT }
   */
  public List<LegReturnRateDateGrpBlockT> getDt() {
    if (dt == null) {
      dt = new ArrayList<LegReturnRateDateGrpBlockT>();
    }
    return this.dt;
  }
