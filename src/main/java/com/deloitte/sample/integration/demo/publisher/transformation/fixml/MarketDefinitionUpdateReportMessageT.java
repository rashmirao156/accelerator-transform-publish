...
/**
 * MarketDefinitionUpdateReport can be found in Volume 3 of the specification
 *
...
@XmlType(
  name = "MarketDefinitionUpdateReport_message_t",
  propOrder = {
    "applSeqCtrl",
    "instrmtScope",
    "reltdMktSeg",
...
public class MarketDefinitionUpdateReportMessageT extends AbstractMessageT {
