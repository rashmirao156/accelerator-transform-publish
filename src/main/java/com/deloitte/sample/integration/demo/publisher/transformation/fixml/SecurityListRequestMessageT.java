...
/**
 * SecurityListRequest can be found in Volume 3 of the specification
 *
...
@XmlType(
  name = "SecurityListRequest_message_t",
  propOrder = {"instrmt", "instrmtExt", "finDetls", "undly", "leg", "reltdInstrmt"}
)
public class SecurityListRequestMessageT extends AbstractMessageT {
