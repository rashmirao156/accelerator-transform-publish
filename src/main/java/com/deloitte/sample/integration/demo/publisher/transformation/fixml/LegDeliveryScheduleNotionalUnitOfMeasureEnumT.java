...
/**
 * Java class for LegDeliveryScheduleNotionalUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="LegDeliveryScheduleNotionalUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "LegDeliveryScheduleNotionalUnitOfMeasure_enum_t")
@XmlEnum
public enum LegDeliveryScheduleNotionalUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  LegDeliveryScheduleNotionalUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static LegDeliveryScheduleNotionalUnitOfMeasureEnumT fromValue(String v) {
    for (LegDeliveryScheduleNotionalUnitOfMeasureEnumT c :
        LegDeliveryScheduleNotionalUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
