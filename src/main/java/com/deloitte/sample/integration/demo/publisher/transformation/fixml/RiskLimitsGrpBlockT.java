...
/**
 * Java class for RiskLimitsGrp_Block_t complex type.
 *
 ...
 *       &lt;sequence>
 *         &lt;group ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}RiskLimitsGrpElements"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}RiskLimitsGrpAttributes"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(
  name = "RiskLimitsGrp_Block_t",
  propOrder = {"riskLmtTyp", "instrmtScope"}
)
public class RiskLimitsGrpBlockT {
   ...
   * there is not a <CODE>set</CODE> method for the riskLmtTyp property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link RiskLimitTypesGrpBlockT }
   */
