...
/**
 * Java class for CommUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="CommUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "CommUnitOfMeasure_enum_t")
@XmlEnum
public enum CommUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  CommUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static CommUnitOfMeasureEnumT fromValue(String v) {
    for (CommUnitOfMeasureEnumT c : CommUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
