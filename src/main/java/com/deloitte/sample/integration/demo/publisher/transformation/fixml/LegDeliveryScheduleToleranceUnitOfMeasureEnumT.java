...
/**
 * Java class for LegDeliveryScheduleToleranceUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="LegDeliveryScheduleToleranceUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "LegDeliveryScheduleToleranceUnitOfMeasure_enum_t")
@XmlEnum
public enum LegDeliveryScheduleToleranceUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  LegDeliveryScheduleToleranceUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static LegDeliveryScheduleToleranceUnitOfMeasureEnumT fromValue(String v) {
    for (LegDeliveryScheduleToleranceUnitOfMeasureEnumT c :
        LegDeliveryScheduleToleranceUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
