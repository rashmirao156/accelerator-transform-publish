...
/**
 * Java class for UnderlyingProvisionOptionExpirationDate_Block_t complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="UnderlyingProvisionOptionExpirationDate_Block_t">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;group ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}UnderlyingProvisionOptionExpirationDateElements"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{http://www.fixprotocol.org/FIXML-5-0-SP2}UnderlyingProvisionOptionExpirationDateAttributes"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(
  name = "UnderlyingProvisionOptionExpirationDate_Block_t",
  propOrder = {"bizCtr"}
)
public class UnderlyingProvisionOptionExpirationDateBlockT {

  @XmlElement(name = "BizCtr")
  protected List<UnderlyingProvisionOptionExpirationDateBusinessCenterGrpBlockT> bizCtr;
  ...
  @XmlAttribute(name = "ExpTm")
  protected XMLGregorianCalendar expTm;

  @XmlAttribute(name = "ExpTmBizCtr")
  protected String expTmBizCtr;
   ...
   * UnderlyingProvisionOptionExpirationDateBusinessCenterGrpBlockT }
   */
  public List<UnderlyingProvisionOptionExpirationDateBusinessCenterGrpBlockT> getBizCtr() {
    if (bizCtr == null) {
      bizCtr = new ArrayList<UnderlyingProvisionOptionExpirationDateBusinessCenterGrpBlockT>();
    }
    return this.bizCtr;
  }
  ...
  /**
   * Gets the value of the expTm property.
   *
   * @return possible object is {@link XMLGregorianCalendar }
   */
  public XMLGregorianCalendar getExpTm() {
    return expTm;
  }

  /**
   * Sets the value of the expTm property.
   *
   * @param value allowed object is {@link XMLGregorianCalendar }
   */
  public void setExpTm(XMLGregorianCalendar value) {
    this.expTm = value;
  }

  /**
   * Gets the value of the expTmBizCtr property.
   *
   * @return possible object is {@link String }
   */
  public String getExpTmBizCtr() {
    return expTmBizCtr;
  }

  /**
   * Sets the value of the expTmBizCtr property.
   *
   * @param value allowed object is {@link String }
   */
  public void setExpTmBizCtr(String value) {
    this.expTmBizCtr = value;
  }
}
