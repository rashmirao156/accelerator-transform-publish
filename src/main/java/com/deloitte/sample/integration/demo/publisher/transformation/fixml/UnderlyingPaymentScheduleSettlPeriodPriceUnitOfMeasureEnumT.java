...
/**
 * Java class for UnderlyingPaymentScheduleSettlPeriodPriceUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="UnderlyingPaymentScheduleSettlPeriodPriceUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "UnderlyingPaymentScheduleSettlPeriodPriceUnitOfMeasure_enum_t")
@XmlEnum
public enum UnderlyingPaymentScheduleSettlPeriodPriceUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  UnderlyingPaymentScheduleSettlPeriodPriceUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static UnderlyingPaymentScheduleSettlPeriodPriceUnitOfMeasureEnumT fromValue(String v) {
    for (UnderlyingPaymentScheduleSettlPeriodPriceUnitOfMeasureEnumT c :
        UnderlyingPaymentScheduleSettlPeriodPriceUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
