...
/**
 * Java class for UnderlyingPaymentStreamRateSpreadUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="UnderlyingPaymentStreamRateSpreadUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "UnderlyingPaymentStreamRateSpreadUnitOfMeasure_enum_t")
@XmlEnum
public enum UnderlyingPaymentStreamRateSpreadUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  UnderlyingPaymentStreamRateSpreadUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static UnderlyingPaymentStreamRateSpreadUnitOfMeasureEnumT fromValue(String v) {
    for (UnderlyingPaymentStreamRateSpreadUnitOfMeasureEnumT c :
        UnderlyingPaymentStreamRateSpreadUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
