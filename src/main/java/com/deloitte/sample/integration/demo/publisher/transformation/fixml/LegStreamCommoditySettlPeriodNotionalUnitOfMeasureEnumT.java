...
/**
 * Java class for LegStreamCommoditySettlPeriodNotionalUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="LegStreamCommoditySettlPeriodNotionalUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "LegStreamCommoditySettlPeriodNotionalUnitOfMeasure_enum_t")
@XmlEnum
public enum LegStreamCommoditySettlPeriodNotionalUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  LegStreamCommoditySettlPeriodNotionalUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static LegStreamCommoditySettlPeriodNotionalUnitOfMeasureEnumT fromValue(String v) {
    for (LegStreamCommoditySettlPeriodNotionalUnitOfMeasureEnumT c :
        LegStreamCommoditySettlPeriodNotionalUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
