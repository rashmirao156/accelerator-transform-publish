...
/**
 * Java class for LegPaymentScheduleRateUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="LegPaymentScheduleRateUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "LegPaymentScheduleRateUnitOfMeasure_enum_t")
@XmlEnum
public enum LegPaymentScheduleRateUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  LegPaymentScheduleRateUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static LegPaymentScheduleRateUnitOfMeasureEnumT fromValue(String v) {
    for (LegPaymentScheduleRateUnitOfMeasureEnumT c :
        LegPaymentScheduleRateUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
