...
/**
 * Java class for PaymentScheduleSettlPeriodPriceUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="PaymentScheduleSettlPeriodPriceUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "PaymentScheduleSettlPeriodPriceUnitOfMeasure_enum_t")
@XmlEnum
public enum PaymentScheduleSettlPeriodPriceUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  PaymentScheduleSettlPeriodPriceUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static PaymentScheduleSettlPeriodPriceUnitOfMeasureEnumT fromValue(String v) {
    for (PaymentScheduleSettlPeriodPriceUnitOfMeasureEnumT c :
        PaymentScheduleSettlPeriodPriceUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
