...
/**
 * Java class for CommissionUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="CommissionUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "CommissionUnitOfMeasure_enum_t")
@XmlEnum
public enum CommissionUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  CommissionUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static CommissionUnitOfMeasureEnumT fromValue(String v) {
    for (CommissionUnitOfMeasureEnumT c : CommissionUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
