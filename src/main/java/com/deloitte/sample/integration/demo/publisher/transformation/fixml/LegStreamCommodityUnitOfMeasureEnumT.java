...
/**
 * Java class for LegStreamCommodityUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="LegStreamCommodityUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "LegStreamCommodityUnitOfMeasure_enum_t")
@XmlEnum
public enum LegStreamCommodityUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  LegStreamCommodityUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static LegStreamCommodityUnitOfMeasureEnumT fromValue(String v) {
    for (LegStreamCommodityUnitOfMeasureEnumT c : LegStreamCommodityUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
