...
/**
 * Java class for PaymentStreamReferenceLevelUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="PaymentStreamReferenceLevelUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "PaymentStreamReferenceLevelUnitOfMeasure_enum_t")
@XmlEnum
public enum PaymentStreamReferenceLevelUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  PaymentStreamReferenceLevelUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static PaymentStreamReferenceLevelUnitOfMeasureEnumT fromValue(String v) {
    for (PaymentStreamReferenceLevelUnitOfMeasureEnumT c :
        PaymentStreamReferenceLevelUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
