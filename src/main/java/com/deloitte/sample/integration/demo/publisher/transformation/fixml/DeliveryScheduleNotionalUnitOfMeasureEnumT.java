...
/**
 * Java class for DeliveryScheduleNotionalUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="DeliveryScheduleNotionalUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "DeliveryScheduleNotionalUnitOfMeasure_enum_t")
@XmlEnum
public enum DeliveryScheduleNotionalUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  DeliveryScheduleNotionalUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static DeliveryScheduleNotionalUnitOfMeasureEnumT fromValue(String v) {
    for (DeliveryScheduleNotionalUnitOfMeasureEnumT c :
        DeliveryScheduleNotionalUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
