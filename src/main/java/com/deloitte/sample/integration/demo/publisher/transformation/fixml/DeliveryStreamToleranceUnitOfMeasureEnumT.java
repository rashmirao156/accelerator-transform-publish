...
/**
 * Java class for DeliveryStreamToleranceUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="DeliveryStreamToleranceUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "DeliveryStreamToleranceUnitOfMeasure_enum_t")
@XmlEnum
public enum DeliveryStreamToleranceUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  DeliveryStreamToleranceUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static DeliveryStreamToleranceUnitOfMeasureEnumT fromValue(String v) {
    for (DeliveryStreamToleranceUnitOfMeasureEnumT c :
        DeliveryStreamToleranceUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
