...
/**
 * NewOrderMultileg can be found in Volume 4 of the specification
 *
...
@XmlType(
  name = "NewOrderMultileg_message_t",
  propOrder = {
    "pty",
    "tgtPty",
    "preAllocMleg",
...
public class NewOrderMultilegMessageT extends AbstractMessageT {
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the preAllocMleg property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link PreAllocMlegGrpBlockT }
   */
