...
/**
 * Java class for UnderlyingDeliveryScheduleNotionalUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="UnderlyingDeliveryScheduleNotionalUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "UnderlyingDeliveryScheduleNotionalUnitOfMeasure_enum_t")
@XmlEnum
public enum UnderlyingDeliveryScheduleNotionalUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  UnderlyingDeliveryScheduleNotionalUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static UnderlyingDeliveryScheduleNotionalUnitOfMeasureEnumT fromValue(String v) {
    for (UnderlyingDeliveryScheduleNotionalUnitOfMeasureEnumT c :
        UnderlyingDeliveryScheduleNotionalUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
