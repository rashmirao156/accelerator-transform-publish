...
/**
 * Java class for LegStrikeUnitOfMeasure_enum_t.
 *
 ...
 *
 * <pre>
 * &lt;simpleType name="LegStrikeUnitOfMeasure_enum_t">
 ...
 * </pre>
 */
@XmlType(name = "LegStrikeUnitOfMeasure_enum_t")
@XmlEnum
public enum LegStrikeUnitOfMeasureEnumT {
  @XmlEnumValue("Bcf")
  BCF("Bcf"),
  @XmlEnumValue("Alw")
  ALW("Alw"),
  ...
  LegStrikeUnitOfMeasureEnumT(String v) {
    value = v;
  }
  ...
  public static LegStrikeUnitOfMeasureEnumT fromValue(String v) {
    for (LegStrikeUnitOfMeasureEnumT c : LegStrikeUnitOfMeasureEnumT.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
